...
//
// IDirect3DDevice9 wrapper methods
//
...
//
// Virtual function tables for IDirect3DDevice9
//

void *g_devvtbld[] = {DEVQueryInterface, DEVAddRef, DEVRelease, DEVTestCooperativeLevel,
...
HRESULT STDMETHODCALLTYPE DDCreateDevice(HDirect3D9 *This, UINT a,D3DDEVTYPE b,HWND c,DWORD d,D3DPRESENT_PARAMETERS* e,IDirect3DDevice9** f)
{
	...
	hd = new HDirect3DDevice9;
	hd->lpVtbl = g_devvtbld;
	hd->original = id;
	hd->d3d = This;
...
//
// Virtual function tables for IDirect3D9
//

void *g_odmvtbld[] = {DDQueryInterface, DDAddRef, DDRelease, DDRegisterSoftwareDevice,
